...
class SchemeEditWidget(QWidget):
    ...
    def __init__(self, parent=None, ):
        ...
        self.__editMenu = QMenu(_("&Edit"), self)
        ...
        # Widget context menu
        self.__widgetMenu = QMenu(_("Widget"), self)
        ...
        self.__menuBarWidgetMenu = QMenu(_("&Widget"), self)
        ...
        self.__linkMenu = QMenu(_("Link"), self)
    ...
    def __setupActions(self):
        self.__cleanUpAction = QAction(
            ...
            toolTip=_("Align widgets to a grid (Shift+A)"),
        ...
        self.__newTextAnnotationAction = QAction(
            ...
            toolTip=_("Add a text annotation to the workflow."),
            checkable=True,
        ...
        self.__newArrowAnnotationAction = QAction(
            ...
            toolTip=_("Add a arrow annotation to the workflow."),
            checkable=True,
        ...
        self.__openSelectedAction = QAction(
            ...
            toolTip=_("Open selected widget"),
        ...
        self.__removeSelectedAction = QAction(
            ...
            toolTip=_("Remove selected items"),
        ...
        self.__renameAction = QAction(
            ...
            toolTip=_("Rename selected widget"),
        ...
        self.__windowGroupsAction = QAction(
            _("Window Groups"), self, objectName="window-groups-action",
    ...
    def removeSelected(self):
        ...
        if not selected:
            return
        scene = self.scene()
        self.__undoStack.beginMacro(_("Remove"))
    ...
    def alignToGrid(self):
        ...
        if nodes:
            self.__undoStack.beginMacro(_("Align To Grid"))
    ...
    def __onSelectionChanged(self):
        ...
        if len(nodes) > 1:
            self.__openSelectedAction.setText(_("Open All"))
        else:
            self.__openSelectedAction.setText(_("Open"))

        if len(nodes) + len(annotations) + len(links) > 1:
            self.__removeSelectedAction.setText(_("Remove All"))
        else:
            self.__removeSelectedAction.setText(_("Remove"))
    ...
    def __showHelpFor(self, help_url):
        ...
        if not handled:
            message_information(
                _("Sorry there is no documentation available for "
                        "this widget."),
                parent=self)
    ...
    def __toggleLinkEnabled(self, enabled):
        ...
        if self.__contextMenuTarget:
            ...
            command = commands.SetAttrCommand(
                link, "enabled", enabled, name=_("Set enabled"),
            )
            self.__undoStack.push(command)
...
class SaveWindowGroup(QDialog):
    ...
    def __init__(self, *args, **kwargs):
        ...
        cb.setEditText(_("Window Group 1"))
        cb.lineEdit().selectAll()
        form.addRow(_("Save As:"), cb)
    ...
    def __accept_check(self):
        ...
        mb = QMessageBox(
            self, windowTitle=_("Confirm Overwrite"),
            icon=QMessageBox.Question,
            standardButtons=QMessageBox.Yes | QMessageBox.Cancel,
            text=_("The window group '{}' already exists. Do you want " +
